...
void vulkan_device_destroy(vulkan_context* context) {
    ...
    if(context->device.swapchain_support.formats) {
        tfree(context->device.swapchain_support.formats,
    ...
    if(context->device.swapchain_support.present_modes) {
        tfree(context->device.swapchain_support.present_modes,
    ...
    tzero_memory(&context->device.swapchain_support.capabilities,
