...
{
    out_framebuffer->attachments = tallocate(sizeof(VkImageView) *
        attachment_count, MEMORY_TAG_RENDERER);
    ...
    vulkan_framebuffer* framebuffer)
{
    ...
    if(framebuffer->attachments) {
        tfree(framebuffer->attachments, sizeof(VkImageView) *
            framebuffer->attachment_count, MEMORY_TAG_RENDERER);
