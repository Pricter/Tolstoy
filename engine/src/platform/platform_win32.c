    ...
    i32 height)
{
    ...
    wc.lpszClassName = "tolstoy_window_class";
    ...
    HWND handle = CreateWindowExA(
        window_ex_style, "tolstoy_window_class", application_name,
    ...
    b32 should_activate = 1; // TODO: This should be false is no input
...
LRESULT CALLBACK win32_process_message(HWND hwnd, u32 msg, WPARAM w_param, LPARAM l_param) {
    switch(msg) {
        case WM_ERASEBKGND:
            ...
            return 1;
        case WM_CLOSE:
            // TODO: Fire an event for application to quit.
            return 0;
        case WM_DESTROY:
            PostQuitMessage(0);
            return 0;
